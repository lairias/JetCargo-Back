...
import { PeopleView,PeopleCreate,PeopleDelete,PeopleUpdate} from "../middleware/permissions/People.Permission";
import {
  GetPeoples,
  GetPeople,
  CreatePeople,
...
router.delete("/:COD_PEOPLE", [verifyToken, verifyIndUser, PeopleUpdate], DeletePeople);
