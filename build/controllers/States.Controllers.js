...
var _require = require("../models/Pa_states"),
    PA_STATES = _require.PA_STATES;
...
exports.GetStates = /*#__PURE__*/function () {
...
exports.GetStatesForCountry = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return sequelize.query("CALL SHOW_STATES_COUNTRY(:COD_COUNTRY)", {
              replacements: {
...
exports.DeleteState = /*#__PURE__*/function () {
...
exports.UpdateState = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 2;
            _context4.next = 5;
            return sequelize.query("CALL UPD_STATE(:COD_STATE, :NAM_STATE,:DES_STATE ,:USR_UPD ,:COD_COUNTRY ) ", {
              replacements: {
                COD_STATE: COD_STATE,
                NAM_STATE: NAM_STATE,
                DES_STATE: DES_STATE,
...
exports.CreateState = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return sequelize.query("CALL INS_STATE(:NAM_STATE,:DES_STATE,:USR_ADD,:COD_COUNTRY)", {
              replacements: {
                NAM_STATE: NAM_STATE,
                DES_STATE: DES_STATE,
                USR_ADD: USR_ADD,
...
exports.GetState = /*#__PURE__*/function () {
