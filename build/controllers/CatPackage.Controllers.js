...
exports.UpdateCatPackage = exports.GetCatPackages = exports.GetCatPackage = exports.DeleteCatPackage = exports.CreateCatPackage = void 0;
...
var GetCatPackages = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _BO_catPackage.BO_CATPACKAGE.findAll();
  ...
  return function GetCatPackages(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.GetCatPackages = GetCatPackages;

var GetCatPackage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _BO_catPackage.BO_CATPACKAGE.findByPk(COD_CATPACKAGE);
  ...
  return function GetCatPackage(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.GetCatPackage = GetCatPackage;
...
var CreateCatPackage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            _context3.next = 5;
            return _index["default"].query("CALL INS_CATPACKAGES(:NAM_CATPACKAGE,:DES_CATPACKAGE,:USR_ADD)", {
              replacements: {
  ...
  return function CreateCatPackage(_x7, _x8, _x9) {
...
var UpdateCatPackage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 2;
            _context4.next = 5;
            return _index["default"].query("CALL UPD_CATPACKAGES(:COD_CATPACKAGE,:NAM_CATPACKAGE,:DES_CATPACKAGE,:USR_UPD)", {
              replacements: {
  ...
  return function UpdateCatPackage(_x10, _x11, _x12) {
    return _ref4.apply(this, arguments);
  };
}();

exports.UpdateCatPackage = UpdateCatPackage;

var DeleteCatPackage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 1;
            _context5.next = 4;
            return _BO_catPackage.BO_CATPACKAGE.destroy({
              where: {
                COD_CATPACKAGE: COD_CATPACKAGE
              }
            });
  ...
  return function DeleteCatPackage(_x13, _x14, _x15) {
    return _ref5.apply(this, arguments);
  };
}();

exports.DeleteCatPackage = DeleteCatPackage;