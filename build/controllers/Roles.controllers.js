...
var _Roles = require("./helpers/Roles.Helpers");
...
var GetRole = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _Pa_typeUsers.PA_TypeUsers.findByPk(COD_TYPEUSERS);

          case 4:
            role = _context.sent;
            _context.next = 7;
            return _database["default"].query("CALL SHOW_PERMISOS_TYPEUSER(".concat(COD_TYPEUSERS, ") "));
  ...
  return function GetRole(_x, _x2, _x3) {
...
var GetRoles = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _database["default"].query("CALL COUNT_TYPE_USERS_ALL_PERMISOS()");
  ...
  return function GetRoles(_x4, _x5, _x6) {
...
var UpdateRole = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 2;
            _context3.next = 5;
            return _Pa_typeUsers.PA_TypeUsers.update({
              NOM_TYPE: NOM_TYPE,
              DES_TYPE: DES_TYPE,
              USR_UPD: USR_UPD
            }, {
          ...
          case 5:
            _context3.next = 7;
            return _typeusers_has_permisos.MODEL_TYPEUSER_HAS_PERMISOS.destroy({
              where: {
                COD_TYPEUSERS: COD_TYPEUSERS
              }
            });
          ...
          case 7:
            ...
            (0, _Roles.RolesForeachAllPermiso)(COD_TYPEUSERS);
            return _context3.abrupt("return", res.sendStatus(200));

          case 12:
            (0, _Roles.RolesForeachPermiso)(PERMISSION, COD_TYPEUSERS);
            return _context3.abrupt("return", res.sendStatus(200));
  ...
  return function UpdateRole(_x7, _x8, _x9) {
...
var DeleteRole = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 4;
            return _Pa_typeUsers.PA_TypeUsers.destroy({
              where: {
                COD_TYPEUSERS: COD_TYPEUSERS
              }
            });
  ...
  return function DeleteRole(_x10, _x11, _x12) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 4:
            ...
            (0, _Roles.RolesForeachAllPermiso)(role.COD_TYPEUSERS);
            return _context5.abrupt("return", res.sendStatus(200));

          case 10:
            (0, _Roles.RolesForeachPermiso)(PERMISSION, role.COD_TYPEUSERS);
            return _context5.abrupt("return", res.sendStatus(200));
