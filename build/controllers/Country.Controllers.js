...
exports.UpdateCountrie = exports.GetCountry = exports.GetCountries = exports.DeleteCountrie = exports.CreateCountry = void 0;
...
var GetCountries = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _Pa_countries.PA_COUNTRIES.findAll({
              where: {
                IND_COUNTRY: 1
              }
            });
  ...
  return function GetCountries(_x, _x2, _x3) {
...
var GetCountry = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _Pa_countries.PA_COUNTRIES.findByPk(COD_COUNTRY);
  ...
  return function GetCountry(_x4, _x5, _x6) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return _index["default"].query("CALL INS_COUNTRY(:NAM_COUNTRY,:DES_COUNTRY,:USR_ADD)", {
              replacements: {
...
var DeleteCountrie = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            _context4.next = 4;
            return _Pa_countries.PA_COUNTRIES.destroy({
              where: {
  ...
  return function DeleteCountrie(_x10, _x11, _x12) {
    return _ref4.apply(this, arguments);
  };
}();

exports.DeleteCountrie = DeleteCountrie;

var UpdateCountrie = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _index["default"].query("CALL UPD_COUNTRY(:COD_COUNTRY,:NAM_COUNTRY,:DES_COUNTRY,:USR_UPD)", {
              replacements: {
                COD_COUNTRY: COD_COUNTRY,
                NAM_COUNTRY: NAM_COUNTRY,
                DES_COUNTRY: DES_COUNTRY,
  ...
  return function UpdateCountrie(_x13, _x14, _x15) {
    return _ref5.apply(this, arguments);
  };
}();

exports.UpdateCountrie = UpdateCountrie;